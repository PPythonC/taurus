...
define(function(require) {
    ...
    function cleanStore(store) {
        zrUtil.each(store, function (record, coordId) {
            if (!record.count) {
                com.example.taurus.web.controller.off('pan').off('zoom');
    ...
    function onPan(record, dx, dy) {
        wrapAndDispatch(record, function (info) {
            return info.panGetRange(com.example.taurus.web.controller, dx, dy);
        });
    }

    function onZoom(record, scale, mouseX, mouseY) {
        wrapAndDispatch(record, function (info) {
            return info.zoomGetRange(com.example.taurus.web.controller, scale, mouseX, mouseY);
        });
    }
