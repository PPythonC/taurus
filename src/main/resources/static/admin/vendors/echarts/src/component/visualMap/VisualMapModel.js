...
define(function(require) {
    ...
    var VisualMapModel = echarts.extendComponentModel({
        ...
        resetVisual: function (fillVisualOption) {
            ...
            doReset.call(this, 'com.example.taurus.web.controller', this.controllerVisuals);
            ...
            function doReset(baseAttr, visualMappings) {
                each(this.stateList, function (state) {
                    ...
                    each(visaulOption, function (visualData, visualType) {
                        ...
                        if (baseAttr === 'com.example.taurus.web.controller' && visualType === 'opacity') {
    ...
    function replaceVisualOption(thisOption, newOption) {
        ...
        var visualKeys = [
            'inRange', 'outOfRange', 'target', 'com.example.taurus.web.controller', 'color'
        ];
        var has;
