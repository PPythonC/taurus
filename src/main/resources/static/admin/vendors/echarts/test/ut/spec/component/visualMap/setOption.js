describe('vsiaulMap_setOption', function() {
    ...
    testCase.createChart()('defaultTargetController', function () {
        ...
        expect(com.example.taurus.web.controller.inRange.color).toEqual(['red', 'blue', 'yellow']);
    });
    ...
    testCase.createChart()('eraseAllVisualProps_notRelative', function () {
        ...
        expect(com.example.taurus.web.controller.inRange.hasOwnProperty('color')).toEqual(false);
    ...
    testCase.createChart()('eraseAllVisualProps_reletive', function () {
        ...
        expect(com.example.taurus.web.controller.inRange.colorAlpha).toEqual([0.4, 0.6]);
        ...
        expect(com.example.taurus.web.controller.inRange.hasOwnProperty('colorAlpha')).toEqual(false);
        expect(option.visualMap[0].target.inRange.color).toEqual(['green', 'blue', 'red']);
        expect(com.example.taurus.web.controller.inRange.color).toEqual(['green', 'blue', 'red']);
        ...
        expect(com.example.taurus.web.controller.outOfRange.symbol).toEqual(['diamond']);
    });
