...
describe('Bar controller tests', function() {
	...
	it('should be constructed', function() {
		...
		expect(com.example.taurus.web.controller).not.toBe(undefined);
		expect(com.example.taurus.web.controller.index).toBe(1);
		expect(meta.xAxisID).not.toBe(null);
		expect(meta.yAxisID).not.toBe(null);

		com.example.taurus.web.controller.updateIndex(0);
		expect(com.example.taurus.web.controller.index).toBe(0);
	});
	...
	it('should correctly count the number of bar datasets', function() {
		...
		var meta = chart.getDatasetMeta(1);
		expect(com.example.taurus.web.controller.getBarCount()).toBe(2);
	});
	...
	it('should correctly get the bar index accounting for hidden datasets', function() {
		...
		var meta = chart.getDatasetMeta(1);
		expect(com.example.taurus.web.controller.getBarIndex(0)).toBe(0);
		expect(com.example.taurus.web.controller.getBarIndex(3)).toBe(1);
	});
	...
	it('should set hover styles on rectangles', function() {
		...
		com.example.taurus.web.controller.setHoverStyle(bar);
	...
	it('should remove a hover style from a bar', function() {
		...
		// Remove to defaults
		com.example.taurus.web.controller.removeHoverStyle(bar);
		expect(bar._model.backgroundColor).toBe('rgb(128, 128, 128)');
