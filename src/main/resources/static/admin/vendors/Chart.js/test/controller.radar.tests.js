...
describe('Radar controller tests', function() {
	...
	it('Should be constructed', function() {
		...
		com.example.taurus.web.controller.updateIndex(1);
	...
	it('should update elements', function() {
		...
		com.example.taurus.web.controller.reset(); // reset first
		...
		com.example.taurus.web.controller.update();
	...
	it('should set point hover styles', function() {
		...
		com.example.taurus.web.controller.update(); // reset first

		var point = meta.data[0];

		com.example.taurus.web.controller.setHoverStyle(point);
	...
	it('should remove hover styles', function() {
		...
		com.example.taurus.web.controller.removeHoverStyle(point);
